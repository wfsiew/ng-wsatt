...
@Component({
  ...
  styleUrl: './record-listing.component.css'
})
export class RecordListingComponent implements OnInit, OnDestroy {
  ...
  readonly uiState = 'record.record-listing';
  ...
  load() {
    ...
    this.isLoading = true;
    this.recordService.list(this.page, AppConstant.PAGE_SIZE).subscribe({ next: (res: any) => {
