...
import { EmpService } from 'src/app/emp/services/emp.service';
...
export class EmpListingComponent implements OnInit, OnDestroy {
  ...
  readonly uiState = 'emp.emp-listing';
  ...
  load() {
    ...
    this.isLoading = true;
    this.empService.list(this.page, AppConstant.PAGE_SIZE).subscribe({ next: (res: any) => {
      this.list = res.body.emps;
